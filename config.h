...
/* volume */
static const char *volume_inc_cmd[] =   { "pactl", "set-sink-volume", "1", "+5%", NULL };
static const char *volume_dec_cmd[] =   { "pactl", "set-sink-volume", "1", "-5%", NULL };
...
static Key keys[] = {
	...
	{ Mod4Mask,                     XK_j,      tagmon,         {.i = -1 } },
	{ Mod4Mask,                     XK_k,      tagmon,         {.i = +1 } },
